...
export function initialize(container, application) {
  ...
  container.phraseEnabled = application.get('phraseEnabled');
  container.phrasePrefix = application.get('phrasePrefix');
  container.phraseSuffix = application.get('phraseSuffix');
